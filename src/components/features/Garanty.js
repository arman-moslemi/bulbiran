  ...
  const [des,setDes]=useState('')
    ...
    const sendReq=()=>{
      ...
      if(name!=""&&productname!=""&&phone!=""&&des!=""){
        axios
        .post(apiUrl + "InsertWarranty",{NameFamily:name,ProductName:productname,Mobile:phone,Email:email,Title:subject,Text:des})
...
alert("با موفقیت انجام شد")
    ...
    <div className="whiteBox">
        <div className="ta-right">
            ...
            <p className="gTitle">گارانتی محصولات خریداری شده</p>
        </div>
        ...
        <br/>
        در صورت داشتن هرگونه سوال یا مشکل در مورد گارانتی و خدمات پس از فروش کارشناسان بالبیران در حد توان شما را راهنمایی خواهند کرد تا بهترین خدمات به عنوان کاربر بالبیران از طرف شرکت گارانتی کننده به شما ارائه گردد.
        </p>
        <Row className="mgt40">
          <Col md={6} className="ta-right">
            ...
            <ul className="garanteList">
              ...
              <li>
                <p> محصولی که سرپیچ از حباب بدون دستکاری جدا شده است.</p>
              </li>
              <li>
                <p>محصول‌ دارای دفرمگی سرپیچ (در صورتیکه قبل از مصرف دارای دفرمگی باشد).</p>
              </li>
              <li>
                <p>محصول‌ دارای لرزش نور و چشمک‌زن.</p>
              </li>
            </ul>
          </Col>
          <Col md={6}>
